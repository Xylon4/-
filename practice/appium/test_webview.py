...
class TestWebview:
    def setup(self):
        ...
        self.driver = webdriver.Remote("http://localhost/wd/hub", des_caps)
    ...
    def test_webview(self):
        ...
        WebDriverWait(self.driver, 10).until(expected_conditions.visibility_of_element_located(phone_num))
