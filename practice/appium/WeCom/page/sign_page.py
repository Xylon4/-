...
class SignPage(BasePage):
    def sign(self):
        ...
        self.parse_action("D:\PycharmProjects\-\practice/\/appium\WeCom\page\sign_page.yaml", "sign")

    def first_sign(self):
        self.parse_action("D:\PycharmProjects\-\practice/\/appium\WeCom\page\sign_page.yaml", "first_sign")