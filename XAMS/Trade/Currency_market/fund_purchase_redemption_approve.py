...
from XAMS.Report.conftest import sheet36, Excel_basedata_zs
from XAMS.Tool.test_excel import TestExcel
from XAMS.basepage_XAMS import BasePageXams


class FundPurchaseRedemptionApprove(BasePageXams):
    # 模拟操作自动化案例
    def fund_purchase_redemption_approve_excel(self, menu, value):
        print(menu)
        print(value)
        self.base = TestExcel()
        basedata = [Excel_basedata_zs, sheet36]
