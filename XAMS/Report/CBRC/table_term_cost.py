# 表内外投资业务期限结构及成本收益表自动化测试用例
# 功能描述：统计表内外投资业务期限结构及成本收益
from time import sleep

from selenium.webdriver.common.by import By
from selenium.webdriver.common.keys import Keys

from XAMS.Report.conftest import sheet38, Excel_basedata_nj
from XAMS.Tool.test_excel import TestExcel
from XAMS.basepage_XAMS import BasePageXams


class TableTermCost(BasePageXams):
    # 模拟操作自动化案例-南京
    def table_term_cost_excel(self, menu, value):
        print(menu)
        print(value)
        self.base = TestExcel()
        basedata = [Excel_basedata_nj, sheet38]
        # 点击一级菜单
