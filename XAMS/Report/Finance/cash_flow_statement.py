...
from XAMS.Report.conftest import sheet52, Excel_basedata_zs
from XAMS.Tool.test_excel import TestExcel
from XAMS.basepage_XAMS import BasePageXams
import math


class CashFlowStatement(BasePageXams):
    # 模拟操作自动化案例-浙商
    def cash_flow_statement_excel(self, menu, value):
        print(menu)
        print(value)
        self.base = TestExcel()
        basedata = [Excel_basedata_zs, sheet52]
        # 点击一级菜单
    ...
    # 升级对比自动化案例-浙商
    def cash_flow_statement_compare(self, menu, value):
        print(menu)
        print(value)
        self.base = TestExcel()
        basedata = [Excel_basedata_zs, sheet52]
