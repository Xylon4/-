...
from XAMS.Report.conftest import sheet51, Excel_basedata_zs
from XAMS.Tool.test_excel import TestExcel
from XAMS.basepage_XAMS import BasePageXams
import math


class VariableReturnMeasurement(BasePageXams):
    # 模拟操作自动化案例-浙商
    def variable_return_measurement_excel(self, menu, value):
        print(menu)
        print(value)
        self.base = TestExcel()
        basedata = [Excel_basedata_zs, sheet51]
        # 点击一级菜单
